...
function Клавиатура-Основная {
    ...
    # Сейчас по одной в ряд, то есть вертикально. Чтобы поставить две в ряд,
    # достаточно объединить: ["Список","Добавить"],["Удалить","Помощь"].
    #
    ...
    return '{"keyboard":[["Список"],["Добавить"],["Удалить"],["Помощь"]],"resize_keyboard":true,"is_persistent":true,"input_field_placeholder":"Артикул или команда"}'
}
