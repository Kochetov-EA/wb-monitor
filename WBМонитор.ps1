...
function Клавиатура-Основная {
    ...
    # Раскладка — вложенные массивы: каждый из них один ряд кнопок.
    # Сейчас: Добавить и Удалить в первом ряду, Список во втором.
    #
    # Клавиатура в Telegram привязана к сообщению, которое ее принесло, и уходит
    # вместе с ним при чистке переписки. Это лечится только следующим ответом бота.
    #
...
function Клавиатура-Удаления {
    ...
    # Кнопка «Список» нужна, чтобы из режима удаления можно было выйти просто так.
...
Кнопки под полем ввода: Добавить, Удалить, Список.

ДОБАВИТЬ ТОВАР — пришли его артикул числом:
1422010347

Так быстрее всего, кнопка Добавить просто напомнит об этом же.
Артикул есть на карточке товара и в ссылке на нее.
Хочешь сразу цель по цене — вторым числом: 1422010347 430000

УБРАТЬ ТОВАР — кнопка Удалить, дальше выбрать нужный.
Знаешь номер — можно сразу: /remove 1422010347

ПОСМОТРЕТЬ — кнопка Список.
